game.MiniPlayerLocation = me.Entity.extend({
	init: function(x,y,settings){
		...
		ctx.fillStyle = "rgba(0,192,3,0.75)";
		ctx.strokeStyle = "blue";
		ctx.lineWidth = 2;

		ctx.arc(this.r + 2, this.r+2,this.r+2, 0, Math.PI*2);
		ctx.fill();
		ctx.stroke();
	...
	update: function(){
		this.pos.x = (10 +(game.data.player.pos.x *0.20));
		this.pos.y = (10 +(game.data.player.pos.y *0.20));
		return true;
	}
});